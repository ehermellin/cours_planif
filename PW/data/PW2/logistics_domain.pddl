(define (domain logistics)
  ...
  (:action load-truck
    ...
    :precondition (and (at ?truck ?loc) (at ?pkg ?loc) (available ?truck))
    :effect (and (not (at ?pkg ?loc)) (in ?pkg ?truck) (not (available ?truck)))
  )
 ...
 (:action unload-truck
   ...
   :effect (and (not (in ?pkg ?truck)) (at ?pkg ?loc) (available ?truck))
 )
